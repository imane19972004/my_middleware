...
//        {
//            // ✅ CORRECTION UTF-8
//            var query = System.Web.HttpUtility.UrlDecode(request.QueryString["q"], System.Text.Encoding.UTF8);
...
//            {
//                // Appel à Nominatim pour l'autocomplétion
//                var url = $"https://nominatim.openstreetmap.org/search?q={Uri.EscapeDataString(query)}&format=json&limit=8&countrycodes=fr&addressdetails=1";
